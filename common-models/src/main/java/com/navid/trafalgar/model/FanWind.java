...
public final class FanWind extends IWind implements Dependent {
    ...
    public FanWind(AssetManager assetManager) {
    ...
    public void commitDependencies() {
        ...
        fire.setStartColor(new ColorRGBA(0f, 1f, 0f, 1.0f));
